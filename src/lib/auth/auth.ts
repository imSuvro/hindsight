...
export const auth = betterAuth({
  ...
  trustedOrigins: [environment.BETTER_AUTH_URL, "http://localhost:3000"],
  ...
  // Framework glue rather than a feature surface: without it, cookies set by a
  // direct auth.api call never reach the browser. Must be last.
  plugins: [nextCookies()],
});
